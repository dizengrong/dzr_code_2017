...
growl_errors(Title, Message) ->
	can_we_growl(errors)
		andalso growl("errors", Title, Message).
...
make_cmd("notifu" = Util, Image, Title, Message) ->
	...
	% [Util, " /q /d 5000 /i \"", ImageWin, "\" /t ", Type," /p \"", Title, "\" /m \"", Message, "\""];
	[".\\notifu\\"++ Util, " /d 5000 /t ", Type," /p \"", Title, "\" /m \"", Message, "\""];
...
can_we_notify(_GrowlOrLog,_MsgType) -> true.
